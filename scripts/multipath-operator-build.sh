...
make VERSION=${VERSION} IMAGE_TAG_BASE=${REGISTRY}/multipath CHANNELS=fast USE_IMAGE_DIGESTS="" \
    manifests bundle generate docker-build docker-push bundle-build bundle-push \
    catalog-build catalog-push catalog-install
